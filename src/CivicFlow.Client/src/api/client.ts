...
export type CaseAttachment = { id: string; originalFileName: string; contentType: string; sizeBytes: number; visibility: 'Public' | 'Internal'; uploadedAtUtc: string; canDelete: boolean }
