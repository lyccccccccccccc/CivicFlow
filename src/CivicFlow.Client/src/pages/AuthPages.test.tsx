...
describe('authentication form metadata', () => {
  ...
  it('derives demo emails from the configured development domain without a password', () => expect(developmentDemoEmails('example.com')).toEqual(['resident@example.com', 'officer@example.com', 'manager@example.com', 'admin@example.com']))
})
