...
{
    /// <inheritdoc />
    public partial class InitialCivicFlowSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperationKey = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EventKey = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstResponseDueAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    FirstResponseCompletedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    FirstResponseWasBreached = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRequests_AspNetUsers_AssignedOfficerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaseActivities_ActorId_OperationKey",
                table: "CaseActivities",
                columns: new[] { "ActorId", "OperationKey" },
                unique: true,
                filter: "[OperationKey] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_CaseActivities_ServiceRequestId_CreatedAtUtc",
                table: "CaseActivities",
                columns: new[] { "ServiceRequestId", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_Status_Priority",
                table: "ServiceRequests",
                columns: new[] { "Status", "Priority" });

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_SubmittedAtUtc",
                table: "ServiceRequests",
